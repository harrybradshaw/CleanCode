...
namespace Tests
{
    ...
    public class Day5Tests
    {
        ...
        public void Day5Part1()
        {
            ...
            var intCode = new IntcodeComputer(input, new IntcodeIoHandler(new long[]{1}));
            intCode.RunProgramUntilHalt();
        ...
        public void Day5Part2Test1()
        {
            ...
            var intCode = new IntcodeComputer(inputString, new IntcodeIoHandler(new long[] {0}));
            intCode.RunProgramUntilHalt();
        ...
        {
            const string inputString = "3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9";
            var intCode = new IntcodeComputer(inputString, new IntcodeIoHandler(new long[]{1}));
            intCode.RunProgramUntilHalt();
