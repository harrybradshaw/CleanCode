...
namespace Day2Tests
{
    ...
    public class Tests
    {
        ...
        public void Day5Part1()
        {
            ...
            var intCode = new IntCode(input, new Io(new []{1}));
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput.Equals(output));
        }
        ...
        public void Day5Part2Test1()
        {
            ...
            var intCode = new IntCode(inputString, new Io(new []{0}));
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput.Equals(0));
        }
        ...
        {
            const string inputString = "3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9";
            var intCode = new IntCode(inputString, new Io(new []{1}));
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput.Equals(1));
        }
        ...
        public void Day5Part2Test3()
        {
            ...
            var intCode = new IntCode(inputString, new Io(inputArray));
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput == 999);
            intCode.Reset();
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput == 1000);
            intCode.Reset();
            intCode.ProcessIntCode();
            Assert.That(intCode.Io.LastOutput == 1001);
        }
