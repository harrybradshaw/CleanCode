...
namespace Tests
{
    ...
    public class Day7Tests
    {
        ...
        public long SinglePassThrusterSettings(string phaseString, string intCode)
        {
        ...
        public long FeedbackThrusterSettings(string phaseString, string intCode)
        {
            var phase = phaseString.Split(',').Select(int.Parse).ToList();
        ...
        public long AllAmplifierFeedbackLoopCalculatesMaximumSignal(string intCode)
        {
